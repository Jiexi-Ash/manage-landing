...
function Testimonials() {
  ...
  return (
    <div className="relative container max-w-8xl mx-auto my-16">
      ...
      <div className="relative z-30 flex flex-col justify-center items-center  px-6 md:flex-row md:justify-between md:items-start md:overflow-x-scroll md:scrollbar-none md:px-0">
